...
/** Canonical live host — single source of truth for absolute URLs (SEO, OG, sitemap, embeds). */
export const SITE_URL = "https://conflict-intel.conflict-intel.workers.dev";
