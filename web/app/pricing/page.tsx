...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: "Full 37-year timeline", included: false },
      { text: "All 161 countries", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "All 161 countries detailed", included: true },
      { text: "All 289 organizations", included: true },
      { text: "Full 37-year timeline", included: true },
      { text: "420K events full access", included: true },
        ...
        <div className="mx-auto mt-20 max-w-2xl">
          ...
          <div className="rounded-lg border border-border bg-surface">
            ...
            {[
              ...
              ["Events", "420K", "~500K", "Classified"],
              ["History", "37 years", "1997+", "Unknown"],
