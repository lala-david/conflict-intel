...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: "Full 38-year timeline", included: false },
      { text: "All 172 countries", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "All 172 countries detailed", included: true },
      { text: "All 286 organizations + 341 persons", included: true },
      { text: "Full 38-year timeline", included: true },
